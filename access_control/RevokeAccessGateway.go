...
// RevokeAccessGateway provides the behavior for remove an access control
// Expected Alternative Behaviors
//  - If the access control exists, GrantAccessGateway will remove and respond with success
